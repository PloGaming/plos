...
/**
 * @name GDT segment flags
 * Flags that describe the tape of a global descriptor table entry
 * @{
 */
 ...
 * This register tells the cpu where to find the global descriptor table
 */
struct GDTR
{
    uint16_t size; ///< How big is the table - 1
    uint64_t offset;///< Where to find the table
